(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                const lock = document.querySelector(".filter-open");
                if (lock) document.documentElement.classList.toggle("menu-open"); else {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("menu-open");
                }
            }
        }));
        if (document.querySelector(".filter-category__btn")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".filter-category__btn")) {
                const lock = document.querySelector(".lock");
                if (lock) document.documentElement.classList.toggle("filter-open"); else {
                    bodyLockToggle();
        ...
        if (document.querySelector(".filter-category__btn")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".filter-category__back")) {
                bodyLockToggle();
                document.documentElement.classList.toggle("filter-open");
            }
        }));
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper_yandex")) resizableSwiper("(max-width: 1439.98px)", ".swiper_yandex", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".swiper_google")) resizableSwiper("(max-width: 1439.98px)", ".swiper_google", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".ready-solution__body")) new Swiper(".ready-solution__body", {
            modules: [ Navigation, Pagination, Parallax ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            navigation: {
                prevEl: ".ready-solution-button-prev",
                nextEl: ".ready-solution-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
        ...
        if (document.querySelector(".have-question__body")) new Swiper(".have-question__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            parallax: true,
            navigation: {
                prevEl: ".have-question-button-prev",
                nextEl: ".have-question-button-next"
            },
            on: {}
        });
        if (document.querySelector(".single-product__slider")) {
            const thumbsSlider = new Swiper(".images-product__thumbs", {
        ...
        if (document.querySelector(".single-club__body")) new Swiper(".single-club__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".case-single__body")) new Swiper(".case-single__body", {
            modules: [ Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    if (document.querySelector(".configurator-menu__title")) {
        const menuTitles = document.querySelectorAll(".configurator-menu__title");
        menuTitles.forEach((title => {
            title.addEventListener("click", (() => {
                menuTitles.forEach((item => item.classList.remove("_link-active")));
                title.classList.add("_link-active");
            }));
        }));
    }
    if (document.querySelector(".configurator-menu__title")) {
        const menuTitles = document.querySelectorAll(".configurator-menu__title");
        const sections = Array.from(menuTitles).map((title => document.querySelector(title.getAttribute("data-goto"))));
        ...
        const observerCallback = entries => {
            entries.forEach((entry => {
                if (entry.isIntersecting) {
                    ...
                    menuTitles.forEach((item => item.classList.remove("_link-active")));
                    if (index !== -1) menuTitles[index].classList.add("_link-active");
                }
            }));
        };
